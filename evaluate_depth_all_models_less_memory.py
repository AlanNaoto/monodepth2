...
if __name__ == "__main__":
    ...
    opts = options.parse()
    opts.eval_mono = True
    opts.eval_split = "waymo_1024x320"  # carla_1024x320 or waymo_1024x320 (I don't want evaluation on "no nights", only on normal)
    opts.data_path = "/home/alan/workspace/mestrado/dataset/WAYMO_1024x320"  # CARLA_1024x320 or WAYMO_1024x320
